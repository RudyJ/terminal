...
function json_error() {
    ...
    case JSON_ERROR_NONE:
        return 'Nenhum erro ocorreu';
    case JSON_ERROR_DEPTH:
        return 'A profundidade máxima da pilha foi excedida';
    case JSON_ERROR_CTRL_CHAR:
        return 'Erro de caractere de controle, possivelmente codificada incorretamente';
    case JSON_ERROR_SYNTAX:
        return 'Erro de sintaxe';
    case JSON_ERROR_UTF8:
        return 'Caracteres UTF-8 malformado, possivelmente incorretamente codificado';
    }
}
